#pragma once
/*
 * The following code was provided by Henrique Ferrolho and his
 * Difusal blog, in the tutorial on loading bmp images, which
 * is what we pretend to do in this project. Major credits and thanks to him.
